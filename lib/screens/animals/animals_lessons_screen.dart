...
class AnimalsLessonListScreen extends StatefulWidget {
  const AnimalsLessonListScreen({super.key, this.initialLessonId});

  final String? initialLessonId;

  @override
  State<AnimalsLessonListScreen> createState() =>
      _AnimalsLessonListScreenState();
}

class _AnimalsLessonListScreenState extends State<AnimalsLessonListScreen> {
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text(
                    '$completedCount / $total discovered',
...
class _LessonCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final gradient = AnimalsTheme.heroGradient(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: highlight
              ...
              : metadata.primaryColor.withValues(alpha: 0.3),
          width: highlight ? 3 : 1.5,
        ),
        boxShadow: [
          BoxShadow(
            color: metadata.primaryColor.withValues(alpha: 0.15),
            blurRadius: 24,
        ...
        onTap: entry.isLocked
            ...
            : () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    settings:
                        const RouteSettings(name: AnimalsRoutes.lessonDetail),
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                                      ...
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          settings: const RouteSettings(
                                            name: AnimalsRoutes.lessonDetail,
                                          ),
                                          builder: (_) => AnimalsLessonScreen(
                                            lessonId: metadata.lessonId,
                                          ),
                ...
                _LessonArtwork(imageUrl: metadata.cardImageUrl),
              ],
            ),
          ),
        ),
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          _NavIcon(icon: Icons.pets_rounded, label: 'Animals'),
          _NavIcon(
