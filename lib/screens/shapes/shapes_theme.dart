...
class ShapesTheme {
  ...
  static const Color canvas = Color(0xFFFFFDFB);
  ...
  static BoxDecoration progressCard({Color? borderColor}) {
    return BoxDecoration(
      ...
      border: Border.all(
        color: borderColor ?? primary.withValues(alpha: 0.08),
      ),
      boxShadow: const [
        BoxShadow(
